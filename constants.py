...
START_Y = SCREEN_HEIGHT - DEFAULT_LINE_HEIGHT * 6.2
...
LITERALLY_GHANDI = 0  # HELPS GENERATE AGGRESSIVENESS OF CONTROLLER
GO_TO_THERAPY = 1000       # HELPS GENERATE AGGRESSIVENESS OF CONTROLLER
